...
const MobileChatLayout = ({
  ...
  return (
    <div className="fixed inset-x-0 top-0 px-4 py-2">
          ...
          <div className="fixed inset-0 overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
              <div className="fixed inset-y-0 left-0 flex max-w-full pr-10 pointer-events-none">
                ...
                >
                  <Dialog.Panel className="w-screen max-w-md bg-black pointer-events-auto">
                    <div className="flex flex-col h-full py-6 overflow-hidden shadow-xl">
